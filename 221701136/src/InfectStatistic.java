...
//	private static HashMap<String, Integer> TypeToNumMap = null;
	...
	/*
	 * 函数功能：判断是否是合法的输入路径 输入参数：string 输出参数：false,true
	 **/
	...
	/*
	 * 函数功能：判断是否是合法的输出路径 输入参数：string 输出参数：false,true
	 **/
	...
	/*
	 * 函数功能：查询路径文件 输入参数：-log路径 输出参数：文件名称
	 **/
	public void searchFile(String address) throws ParseException, IOException {
		...
		// 用于判断文件最新的更新时间，若没提供-date则将最新时间设为commandDate
